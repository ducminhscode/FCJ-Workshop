...
| Tue | - Hands-on practice: Using AWS Backup to centrally manage and automate data protection for services such as EBS, RDS, DynamoDB, and EFS ([Module 04 - Lab 13](https://drive.google.com/drive/folders/1xGjj8feG0K4l9q4sOejxJuxYpPim-pLR?usp=sharing)):<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Prepare infrastructure: Create S3 Bucket and deploy infrastructure<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Create Backup Plan (frequency and retention settings), assign resources<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Configure notifications using Amazon SNS<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Test operations: Manual backup, restore verification, and notification validation<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Clean up resources | 17/03/2026 | 17/03/2026 | [Deploy AWS Backup to the System](https://000013.awsstudygroup.com/) |
...
| Fri | - Hands-on practice: Configuring AWS Storage Gateway to build a storage bridge between on-premises and AWS ([Module 04 - Lab 24](https://drive.google.com/drive/folders/1XCUuNDfmr1AnilJTwEEONTN-XD7nTZhx?usp=sharing)):<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Prepare infrastructure: Create S3 Bucket and deploy Gateway server (EC2)<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Initialize Storage Gateway (Free Tier limitation noted): Configure local cache<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Create File Shares connected to S3 Bucket and configure access control<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Mount File Share from on-premises environment and validate data<br>&nbsp;&nbsp;&nbsp;&nbsp;+ Clean up resources | 20/03/2026 | 20/03/2026 | [Using File Storage Gateway](https://000024.awsstudygroup.com/) |
...
- Hands-on Labs:
  - **Lab 13:** Successfully deployed AWS Backup with Backup Plans, configured resources, set up notifications using Amazon SNS, and validated backup/restore processes.
  ...
  - **Lab 24:** Implemented hybrid storage using AWS Storage Gateway, configured S3 File Share, mounted from on-premises environment, and validated data synchronization.
